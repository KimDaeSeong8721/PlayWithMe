						...
						<form id="searchArticleForm" class="search">
							...
							//	out.println("<a href='/term/board/'"+ pageend +"/p/' class='next' style='visibility:hidden'>다음 ></a>");	
							   ...
							   int start_offset= (Integer.parseInt(boardpagecode)-1) / 10 * 10 * 10; // 0 ~99 100~199
								...
								if(pagestart!=1) 
									out.println("<a href='/term/board/my" + "/p/"+ (pagestart-1) + "' class='prev'>이전</a>");
								else
									out.println("<a href='/term/board/my" + "/p/"+ (pagestart-1) + "' class='prev' style='visibility:hidden'>이전</a>");
								...
								if(isExistNext)
									out.println("<a href='/term/board/my" +"/p/"+pageend +"' class='next' >다음 ></a>");
								else
									out.println("<a href='/term/board/my" +"/p/' class='next' style='visibility:hidden'>다음 ></a>");	
							%>
