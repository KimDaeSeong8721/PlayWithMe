	...
	var chbAllowed = document.getElementById("chbAllowed");             //체크박스 메모
	var chbShowSingles = document.getElementById("chbShowSingles");     //체크박스 혼자인것
